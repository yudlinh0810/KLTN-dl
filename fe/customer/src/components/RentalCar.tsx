      ...
      <div className={styles.content}>
        <div className={styles.description}>
          ...
          <div className={styles.text}>
            <h4>Dịch vụ thuê xe du lịch giá rẻ</h4>
            <ul>
        ...
        <div className={styles.action}>
          <div className={styles.top}>Thuê xe du lịch cùng VEXE trong 3 bước</div>
          <div className={styles.container}>
            <div className={styles.bottom}>
              <div className={styles.item}>
                <div className={styles.name}>Mô tả lịch trình</div>
                <div className={styles.detail}>
                  Mô tả chi tiết lịch trình theo từng gói dịch vụ sẽ giúp Vexere tính toán và báo
                  giá cho bạn tốt hơn.
                </div>
              </div>
              <div className={styles.item}>
                ...
                <div className={styles.detail}>
                  Giá thuê xe tại Vexere là giá trọn gói dịch vụ, bạn sẽ không phải trả thêm bất cứ
                  chi phí gì
                </div>
              </div>
              <div className={styles.item}>
                ...
                <div className={styles.detail}>
                  Xác nhận thuê xe sẽ được gửi tới bạn qua tin nhắn hoặc email. Sẵn sàng tận hưởng
                  chuyến đi thôi!
                </div>
              </div>
            </div>
