        ...
        <div className={styles.statsList}>
          <div className={styles.statItem}>
            <img
              ...
              alt="Hơn 40 triệu lượt khách"
              className={styles.icon}
            />
            <div className={styles.text}>
              <strong>
                Hơn 5 Triệu <span>Lượt khách</span>
              </strong>
          ...
          <div className={styles.statItem}>
            <img
              ...
              alt="Hơn 350 phòng vé"
              className={styles.icon}
            />
            <div className={styles.text}>
              <strong>
                Hơn 10 <span>Phòng vé - Bưu cục</span>
              </strong>
              <p>
                VEXETIENICH có hơn 10 phòng vé, trạm trung chuyển, bến xe,... trên toàn hệ thống
              </p>
            </div>
          </div>
          ...
          <div className={styles.statItem}>
            <img
              ...
              alt="Hơn 6.500 chuyến xe"
              className={styles.icon}
            />
            <div className={styles.text}>
              <strong>
                Hơn 1000 <span>Chuyến xe</span>
              </strong>
